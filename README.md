...
Real results, real companies, real users:
...
- **Kotlin Multiplatform & Compose Multiplatform** — Shared-code apps across Android, iOS, Desktop, and Web
- **Mobile** — Android (Kotlin/Java) & iOS (Swift/SwiftUI), production apps at scale
- **Backend** — Spring Boot, Ktor, SQL/NoSQL, Firebase, clean architecture
...
- **AI-Augmented Development** — Using Claude, OpenAI, and custom agent pipelines to accelerate delivery under my quality oversight
- **IDE Tooling & DX** — Contributing to VS Code & IntelliJ plugin ecosystems (TypeScript & Kotlin)
- **Prompt Engineering & Metrics** — Optimizing KPI pipelines, delivery efficiency, and developer experience
- **Cloud & Observability** — AWS, OpenTelemetry, CI/CD, monitoring, production reliability
...
## <img src="https://media.giphy.com/media/iY8CRBdQXODJSCERIr/giphy.gif" width="28"> &nbsp;Industries
...
<sub>Yara International</sub>
</td>
<td align="center" width="25%">
<b>Automotive</b><br/>
<sub>Renault Digital</sub>
</td>
<td align="center" width="25%">
<b>AI & Startups</b><br/>
<sub>Multiple ventures</sub>
</td>
</tr>
</table>
...
## <img src="https://media.giphy.com/media/WUlplcMpOCEmTGBtBW/giphy.gif" width="28"> &nbsp;How I Work With AI

I use AI-assisted development as a force multiplier — not a replacement for engineering judgment.

I architect the solution, define the trade-offs, and make the technical decisions. I use tools like Claude and custom agent pipelines to accelerate the writing and reviewing of code. Then I own the final quality gate and take full responsibility for what ships.
...
## <img src="https://media.giphy.com/media/cj87CxfRtrUifF3Ryk/giphy.gif" width="28"> &nbsp;Leadership & Founding
